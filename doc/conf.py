...
print("xarray_extras: %s, %s" % (xarray_extras.__version__, xarray_extras.__file__))
...
version = xarray_extras.version.short_version
# The full version, including alpha/beta/rc tags.
release = xarray_extras.__version__
...
htmlhelp_basename = 'xarray_extrasdoc'
...
latex_documents = [
  ('index', 'xarray_extras.tex', 'xarray_extras Documentation',
   'xarray_extras Developers', 'manual'),
]
...
man_pages = [
    ('index', 'xarray_extras', 'xarray_extras Documentation',
     ['xarray_extras Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'xarray_extras', 'xarray_extras Documentation',
   'xarray_extras Developers', 'xarray_extras',
